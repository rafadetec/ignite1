...
export function Subscribe(){
   ...
   const [createSubscriber, {loading}] = useMutation(CREATE_SUBSCRIBER_MUTATION)  //useMutation Ele devolve duas coisas a função para realizar 
            ...
            <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
                ...
                <div className="p-8 bg-gray-700 border border-gray-500 rounded">
                    ...
                    <form onSubmit={handleSubscribe} className="flex flex-col gap-2 w-full">
                        ...
                        <button
                            type="submit"
                            className="mt-4 bg-green-900 uppercase py-4 rounded font-bold text-sm hover:bg-green-700 transition-colors"
                        >
                            Entrar
                        </button>
                    </form>
